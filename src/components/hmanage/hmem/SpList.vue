<template>
    ...
    <div class="splist">
        ...
        <div class="buttonbox">
            <div class="pullleft">
                <el-button type="success" size="mini" @click="shebeiHuanyuanClick">还原</el-button>
        ...
        <el-dialog
                title="设备还原"
                :visible.sync="shebeihuanyuanShow"
                @close="closeShebeiHandle"
                width="1000px">
            <span slot="title" class="dialogtitle">
                设备还原
              </span>
            <huanyuan @closeHuanyuanHandle="closeHuanyuanHandle" ></huanyuan>
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    import huanyuan from '@/components/globaltem/Huanyuan'
    ...
    export default {
        ...
        methods:{
            ...
            exportHandle(){
                ...
                vm.$http.post('equipmentRecordController/importEquipmentRecord',{
                    recordCode:vm.formInline.recordCode,
                    starTime:vm.formInline.starTime,
                    endTime:vm.formInline.endTime,
                    createPersonName:vm.formInline.createPersonName,
            ...
            shebeiHuanyuanClick(){//还原
                ...
                this.shebeihuanyuanShow =true

            },
            closeHuanyuanHandle(str){
                this.shebeihuanyuanShow = false
                if(str){
                    this.requestList()
                }
            }
        ...
        components:{
            baofeidanhao,shebeichuli,huanyuan
        }
    }
</script>
